...
<aside
    ...
    <nav>
        <ul>
            ...
            <li
                class="mb-3 hover:bg-slate-700 rounded-md {{ Request::is('dashboard-pasien/konsultasi*') ? 'bg-slate-700' : '' }}">
                <a href="/dashboard-pasien/konsultasi" class="flex items-center p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" class="fill-current mr-2"
